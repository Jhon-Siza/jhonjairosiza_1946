...
main(){
    ...
    cout<<endl;
    cout<< "El nro de comparaciones burbuja v1 = "<<ordenaBurbujav1(vec,ne)<<endl;
    cout<<"El nro de comparaciones burbuja v2= "<<ordenaBurbujav2(vec,ne)<<endl;
    cout<<"El nro de comparaciones burbuja v3= "<<ordenaBurbujav3(vec,ne)<<endl;
